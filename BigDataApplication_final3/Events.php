...
<?php
     ...
     if($resultCheck > 0){
          ...
          while($row = mysqli_fetch_assoc($result)){
               ...
               "<td><input type='button' value='Update' onclick='updateEvents(".$row['id'].")' class=\"btn btn-primary\"/>
			   <input type='button' value='Delete' onclick='deleteEvents(".$row['id'].")' class=\"btn btn-danger\"/>
			   </td>". 
               "</tr>";
          }
          echo "</tbody>";
