...
<?php
     ...
     if($resultCheck > 0){
          ...
          while($row = mysqli_fetch_assoc($result)){
               ...
               "<td>" . $row['city'] . "</td>". 
               "<td><input type='button' value='Update' class='btn btn-primary' onclick='updateGames(".$row['id'].")'/>
			   <input type='button' value='Delete' class='btn btn-primary' onclick='deleteGames(".$row['id'].")'/>
			   </td>". 
               "</tr>";
          }
          echo "</tbody>";
